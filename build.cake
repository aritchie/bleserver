...
Task("nuget")
	...
	.Does(() =>
{
    NuGetPack(new FilePath("./nuspec/Acr.Bluetooth.nuspec"), new NuGetPackSettings());
    NuGetPack(new FilePath("./nuspec/Acr.Ble.nuspec"), new NuGetPackSettings());
    //NuGetPack(new FilePath("./nuspec/Acr.Ble.Server.nuspec"), new NuGetPackSettings());
    //NuGetPack(new FilePath("./nuspec/Acr.Beacons.nuspec"), new NuGetPackSettings());
    ...
    .Does(() =>
{
    ...
    {
         RepositoryUrl = "https://github.com/aritchie/bluetooth",
         Branch = "master"
    });
